...
#ifndef FRP_GUI_SWIFT_H
#define FRP_GUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="frp_gui",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7frp_gui11AppDelegate")
...
SWIFT_CLASS("_TtC7frp_gui17MainFlutterWindow")
