...
//单个配置展示卡片组件
Container _frpcTomlCard(BuildContext context, Map<String, dynamic> tunnel) {  
  final enabled = tunnel['_enabled'] == true;
  return Container(
    height: 100,
    decoration: BoxDecoration(color: Theme.of(context).colorScheme.surfaceContainerLow, borderRadius: BorderRadius.circular(10), border: Border.all(color: Theme.of(context).colorScheme.outlineVariant)),
    child: Stack(
      children: [
        //隧道开关
        Positioned(
          ...
          child: switchConfigState(
            ...
            onChanged: (value) async {
              ...
              await toggleTunnelConfigBySuffix(path, value);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 25,
                width: 40,
                decoration: BoxDecoration(color: Theme.of(context).colorScheme.surfaceContainerLow, borderRadius: BorderRadius.circular(5),  border: Border.all(color: Theme.of(context).colorScheme.outlineVariant)), 
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                return SizedBox(
                  ...
                  child: _frpcTomlCard(context, tunnels[index]),
                );
              },
            );
          },
