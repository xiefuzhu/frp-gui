                              ...
                              child:  Wrap(
                                ...
                                children: List.generate(_colorMode.length, (int index,) {
                                  return  InkWell(
                                    ...
                                    //ink可以让涟漪动画居于上方
                                    child: Ink(
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: _colorMode[index], boxShadow: [BoxShadow(color: _colorMode[index].withAlpha(200), blurRadius: 7, spreadRadius: 0.5, offset: const Offset(2, 3))]),
                                      width: 46,
                                      height: 46,
                                      child: Stack(
                                        children: [
                                          //选中显示图标，即√
                                          Positioned(top: 13, bottom: 13,right: 13, child: Icon(Icons.check, color: colorMode == _colorMode[index] ? Colors.white : Colors.transparent, size: 20,)),
                                          //吸管图标，用于标明该颜色为跟随系统颜色
                                          Positioned(bottom: -1,right: -1, child: Icon(Icons.colorize, color: _colorMode[index] == SystemTheme.accentColor.accent ? Colors.white : Colors.transparent, size: 20,))
                                        ],
                                      )
                                    ),
                                  );
              ...
              Positioned(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: Theme.of(
                      context,
                    ).colorScheme.surfaceTint.withAlpha(150),
                    fontSize: 20,
                  ),
                ),
              ),
